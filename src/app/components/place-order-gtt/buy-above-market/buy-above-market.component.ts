...
@Component({
  selector: 'app-buy-above-market',
  templateUrl: './buy-above-market.component.html',
  styleUrl: './buy-above-market.component.css',
})
export class BuyAboveMarketComponent {
  tradingSymbol: string = ''; // Stores the input value
  enteredSymbols: string[] = []; // Stores submitted trading symbols
  apiUrl = 'http://127.0.0.1:8000/stocks/buy-above-market/'; // Backend API
